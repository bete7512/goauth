...
func (h *AuthHandler) parsePhoneVerificationRequest(r *http.Request) (*schemas.SendPhoneVerificationRequest, map[string]interface{}, error) {
...
func (h *AuthHandler) generatePhoneVerificationCode() (string, string, error) {
...
func (h *AuthHandler) sendPhoneVerificationSMSAsync(ctx context.Context, user *models.User, verificationCode string) error {
