...
func (h *AuthHandler) parseRegistrationRequest(r *http.Request) (*schemas.RegisterRequest, map[string]interface{}, error) {
...
func (h *AuthHandler) validateRegistrationRequest(req *schemas.RegisterRequest) error {
...
func (h *AuthHandler) createUserAccount(ctx context.Context, req *schemas.RegisterRequest) (*RegistrationResult, error) {
...
func (h *AuthHandler) handleVerificationFlow(ctx context.Context, user *models.User) error {
...
func (h *AuthHandler) buildRegistrationResponse(result *RegistrationResult) map[string]interface{} {
