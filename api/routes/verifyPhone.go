...
func (h *AuthHandler) parseVerifyPhoneRequest(r *http.Request) (*schemas.VerifyPhoneRequest, map[string]interface{}, error) {
...
func (h *AuthHandler) generatePhoneVerificationResponse(ctx context.Context, method string, user *models.User, w http.ResponseWriter) (map[string]interface{}, error) {
