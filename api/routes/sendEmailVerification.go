...
func (h *AuthHandler) generateVerificationToken() (string, string, error) {
...
func (h *AuthHandler) sendVerificationEmailAsync(ctx context.Context, user *models.User, verificationToken string) error {
