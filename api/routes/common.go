...
func (h *AuthHandler) setupEmailVerification(ctx context.Context, user *models.User) error {
...
func (h *AuthHandler) setupPhoneVerification(ctx context.Context, user *models.User) error {
...
func (h *AuthHandler) getUserByPhoneNumber(ctx context.Context, phoneNumber string) (*models.User, error) {
