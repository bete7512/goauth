...
func (h *AuthHandler) parseVerifyEmailRequest(r *http.Request) (*schemas.VerifyEmailRequest, map[string]interface{}, error) {
...
func (h *AuthHandler) validateVerifyEmailRequest(req *schemas.VerifyEmailRequest) error {
	if req.Token == "" {
...
func (h *AuthHandler) generateVerificationResponse(ctx context.Context, method string, user *models.User, w http.ResponseWriter) (map[string]interface{}, error) {
...
func (h *AuthHandler) sendWelcomeEmailAsync(ctx context.Context, user *models.User) {
