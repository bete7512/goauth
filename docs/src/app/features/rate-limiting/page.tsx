    ...
    <main className="flex-1 overflow-auto">
      <div className="container mx-auto p-8 max-w-4xl">
        <header className="mb-8">
          ...
          <p className="text-lg text-muted-foreground">Protect your API from abuse and brute-force attacks with configurable rate limiting.</p>
        </header>
        <Card className="mb-8">
          <CardHeader>
            <CardTitle>Configuration</CardTitle>
            <CardDescription>Enable and configure rate limiting in your go-auth config</CardDescription>
          </CardHeader>
          <CardContent>
    ...
    // ...
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>Rate limiting is applied automatically to authentication endpoints</CardDescription>
          </CardHeader>
          <CardContent>
            <CodeBlock title="Example: Too Many Requests Response">
...
{"error": "Too many requests. Please try again later."}`}
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>Adjust rate limits based on your application's needs</CardDescription>
          </CardHeader>
          <CardContent>
            <ul className="list-disc pl-6 text-sm text-muted-foreground space-y-2">
              <li>Set reasonable limits to balance security and usability</li>
              <li>Use Redis for distributed rate limiting in production</li>
              <li>Monitor rate limit metrics and adjust as needed</li>
            </ul>
          </CardContent>
        </Card>
        <Card>
