...
// func (m *MockTokenRepository) SaveToken(userID, token string, tokenType types.TokenType, expiry time.Duration) error {
// 	args := m.Called(userID, token, tokenType, expiry)
// 	return args.Error(0)
// }

// func (m *MockTokenRepository) SaveTokenWithDeviceId(userID, token, deviceId string, tokenType types.TokenType, expiry time.Duration) error {
// 	args := m.Called(userID, token, deviceId, tokenType, expiry)
// 	return args.Error(0)
// }

// func (m *MockTokenRepository) GetTokenByUserID(userID string, tokenType types.TokenType) (*types.Token, error) {
// 	args := m.Called(userID, tokenType)
// 	return args.Get(0).(*types.Token), args.Error(1)
// }

// func (m *MockTokenRepository) InvalidateToken(userID, token string, tokenType types.TokenType) error {
// 	args := m.Called(userID, token, tokenType)
// 	return args.Error(0)
// }

// func (m *MockTokenRepository) InvalidateAllTokens(userID string, tokenType types.TokenType) error {
// 	args := m.Called(userID, tokenType)
// 	return args.Error(0)
// }
