...
func NewGenerator(modules []config.Module) *SwaggerGenerator {
	return &SwaggerGenerator{
		modules:  modules,
		baseSpec: getBaseSpec(),
	}
}
...
func getBaseSpec() map[string]interface{} {
	return map[string]interface{}{
		"openapi": "3.0.3",
		"info": map[string]interface{}{
			"title":       "Go-Auth API",
			"description": "Modular authentication library for Go",
			"version":     "0.0.1",
		},
		"servers": []interface{}{
