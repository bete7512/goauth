...
// ConfigEventHandler is event handler from config package
type ConfigEventHandler func(ctx context.Context, event *ConfigEvent) error
...
func (a *EventBusAdapter) Subscribe(eventType string, handler ConfigEventHandler, opts ...interface{}) {
